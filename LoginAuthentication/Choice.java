...
public class Choice implements ActionListener{
	...
	Choice(){
		...
		c.setBackground(Color.getColor("Blue", 29));
		...
		space.setBackground(Color.getColor("Blue", 29));
		
		p1.setLayout(new FlowLayout(FlowLayout.CENTER));
		p1.add(login);
		p1.setBackground(Color.getColor("Blue", 29));
		
		p2.setLayout(new FlowLayout(FlowLayout.CENTER));
		p2.add(register);
		p2.setBackground(Color.getColor("Blue", 29));
