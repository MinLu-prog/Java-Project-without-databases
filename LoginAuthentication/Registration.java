...
public class Registration implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == resetButton) {
            ...
            try (Scanner scanner = new Scanner(new File("D:\\LoginAuthentication\\IDAndPassword.txt"))) {
                ...
                FileWriter output = new FileWriter(("D:\\LoginAuthentication\\IDAndPassword.txt"), true);
